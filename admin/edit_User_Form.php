      ...
      <?php
		...
		if ($result) {
			...
			echo ("<tr><td>User \t $row[user_id]</td></tr>"); //Display only. Non-Editable;
       		echo ("<tr><td>Email:<input type='text' name='eMail' size='20' maxlength='50' value=$row[email]></td></tr>");
       		echo ("<tr><td>Password:<input type='text' name='password' size='10' value=$row[pword]></td></tr>");
       	 	echo ("<tr><td>First:<input type='text' name='fname' size='30' value=$row[first_name]></td></tr>");
		 	echo ("<tr><td>Last:<input type='text' name='lname' size='30' value=$row[last_name]></td></tr>");
		 	...
		 	echo ("<tr><td>Home Street:<input type='text' name='hStreet' size='15' value=$row[home_street]></td></tr>");
       		...
       		echo ("<tr><td>Home City:<input type='text' name='hCity' size='15' value=$row[home_city]></td></tr>");
