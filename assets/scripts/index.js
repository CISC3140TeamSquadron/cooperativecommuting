	...
	function ajaxrequest( php_file, tagID ) 
	{
		...
		request.onreadystatechange = function( ) 
		{
			if ( request.readyState == 4 )
			{
				...
				if ( data_fields[0] == "Welcome!" ) // Added a user. Now to change the sign up button and account column.
				{	
	...
	function ajaxrequest( php_file, tagID ) 
	{
		...
		request.onreadystatechange = function( ) 
		{
			if ( request.readyState == 4 )
			{
				...
				{	
					// Getting Welcome back! from login_user.php means they actually had an account int he SQL DB.
